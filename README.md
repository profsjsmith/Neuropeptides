...
This repo contains materials pertinent to three related posters: one presented at a Stanford meeting in 2025, one presented at the Dendrites Gordon Conference in Ventura CA in 2025 and one presented at the 2025 SfN annual meeting in San Diego.
...
The PDF file Smith_poster_SfN_2025.pdf is a compressed version of the file from which the SfN 2025 poster was printed.
...
The ZIP archive “Scripts_and_helper_files_SfN_2025” includes the JUPYTER notebook scripts and minor resource files used to generate all data graphics for the poster, “An Intriguing Puzzle of Cortical Cholecystokinin (CCK) Gene Expression”, displayed at the SfN Annual Meeting in San Diego on 17 Nov 2025.

These scripts are posted here in interests of scientific rigor and analysis documentation. These  scripts are definitely NOT ready for easy “load and go” execution. Execution of any would require extensive expert environment configuration and download of numerous large, publicly available primary data files, as described in publications cited on the poster and called out by the readme in the present “Primary_scRNAseq_Data” sub-folder. Script execution and reproduction of the poster grapics should be possible for any experienced pythonic data scientist.
